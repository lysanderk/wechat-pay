...
var URLS = {
  ...
  QUERY_COUPON:"https://api.mch.weixin.qq.com/promotion/query_coupon"
};
...
//partner_trade_no: 商户此次发放凭据号（格式：商户id+日期+流水号），商户侧需保持唯一性
Payment.prototype.sendCoupon = function(params, callback){
  this._signedQuery(URLS.SEND_COUPON, params, {
    https: true,
    required: ["coupon_stock_id","openid_count","partner_trade_no"]
  }, callback);
};


Payment.prototype.queryCouponStock = function(params, callback){
  this._signedQuery(URLS.QUERY_COUPON_STOCK, params, {
    https: true,
    required: ["coupon_stock_id"]
  }, callback);
};


Payment.prototype.queryCoupon  = function(params, callback){
  this._signedQuery(URLS.QUERY_COUPON, params, {
    https: true,
    required: ["coupon_stock_id"]
  }, callback);
};
